...
CREATE TYPE "public"."product_status" AS ENUM('user', 'admin');--> statement-breakpoint
...
CREATE TABLE "users" (
	...
	"email" text NOT NULL,
	"name" text NOT NULL,
	"role" "product_status" DEFAULT 'user' NOT NULL,
	"imageUrl" text,
...
--> statement-breakpoint
CREATE TABLE "user_lesson_complite" (
	"userId" uuid NOT NULL,
	"lessonId" uuid NOT NULL,
	"createdAt" timestamp with time zone DEFAULT now() NOT NULL,
	"updatedAt" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "user_lesson_complite_userId_lessonId_pk" PRIMARY KEY("userId","lessonId")
);
--> statement-breakpoint
ALTER TABLE "course_products" ADD CONSTRAINT "course_products_courseId_courses_id_fk" FOREIGN KEY ("courseId") REFERENCES "public"."courses"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user_lesson_complite" ADD CONSTRAINT "user_lesson_complite_userId_users_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_lesson_complite" ADD CONSTRAINT "user_lesson_complite_lessonId_lessons_id_fk" FOREIGN KEY ("lessonId") REFERENCES "public"."lessons"("id") ON DELETE cascade ON UPDATE no action;